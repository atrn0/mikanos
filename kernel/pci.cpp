...
Error ScanFunction(uint8_t bus, uint8_t device, uint8_t function) {
  ...
  uint8_t base = (class_code >> 24) & 0xffu;  // 0b11111111u
  uint8_t sub = (class_code >> 16) & 0xffu;   // 0b11111111u
...
namespace pci {
void WriteAddress(uint32_t address) { IoOut32(kConfigAdress, address); }
