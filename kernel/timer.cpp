...
// You can use the volatile qualifier to provide access to memory locations that
// are used by asynchronous processes such as interrupt handlers.
/** @brief Local Vector Table register */
